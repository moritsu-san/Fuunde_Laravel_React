...
<template>
    <div id="header-news" class="mt-6">
        <div v-show="message.content" id="alert-3" class="flex w-1/2 px-3 py-2 mt-4 absolute top-8 md:top-8 right-0 md:left-1/4 bg-blue-100 rounded-lg" role="alert">
            ...
            <button @click="reset" type="button" class="ml-auto -mx-1.5 -my-1.5 bg-blue-100 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8" data-dismiss-target="#alert-3" aria-label="Close">
