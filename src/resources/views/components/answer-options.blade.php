@if( Auth::id() === $answer->user_id )
    ...
    <div id="dropdown" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700">
        <ul class="py-1" aria-labelledby="dropdownButton">
            <li>
                <a href="#" class="block px-4 py-2 text-sm text-red-700 hover:bg-gray-100" data-modal-toggle="popup-modal" data-bs-target="#modal-delete-{{ $thread->id }}"><i class="fas fa-trash-alt mr-1" style="color: rgb(206, 21, 21)"></i>お題を削除する</a>
            </li>
        </ul>
    </div>
    <!-- Dropdown menu -->
